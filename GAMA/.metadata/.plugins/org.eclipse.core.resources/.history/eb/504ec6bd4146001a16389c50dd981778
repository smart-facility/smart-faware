...
species catchment {
	...
	aspect catchments{
		draw shape color: catch_color border: #black width: 2.0;
	}
...
experiment Run type: gui {
   ...
   //display maps, only for GAMA
      ...
      display map_catchments type: opengl {
      	...
      	species rain_cell aspect: cells refresh: true position: {0, 0, 0.1} transparency: 0.5;
      	grid rain_cell lines: #black position: {0, 0, 0.1} transparency: 0.9;
         
      }
      
      display charts refresh:every(1 #cycles){
      	chart "catchment37" type: series { data "total volume" value: (total_volume_global at 36)  color: #green; }
      	chart "catchment37" type: series { data "output volume" value: (hydro at 36)  color: #blue; }
      }
